...
export const lessonConcepts: ConceptPair[] = [
  {
    concept: "You can request more resources like crew or materials to catch up.",
    hints: [
  ...
  {
    concept: "You can talk to your supervisors about how to reduce or focus the mission scope.",
    hints: [
